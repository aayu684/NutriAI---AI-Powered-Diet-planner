...
class DietPlanPDFGenerator:
    ...
    def _create_weekly_overview(self, diet_plan: WeeklyDietPlan) -> List:
        ...
        summary_data = [
            ["Metric", "Value"],
            ["Total Calories (weekly)", f"{diet_plan.weekly_summary.total_calories}"],
            ["Average Protein (g/day)", f"{diet_plan.weekly_summary.avg_protein}"],
            ["Average Carbs (g/day)", f"{diet_plan.weekly_summary.avg_carbs}"],
            ["Average Fat (g/day)", f"{diet_plan.weekly_summary.avg_fat}"]
        ]
    ...
    def _create_meal_section(self, meal: MealPlan) -> List:
        ...
        if meal.nutrition_info:
            nutrition_text = f"<b>Nutrition:</b> {meal.nutrition_info.calories} cal, " \
                           f"{meal.nutrition_info.protein}g protein, " \
                           f"{meal.nutrition_info.carbs}g carbs, " \
                           f"{meal.nutrition_info.fat}g fat"
